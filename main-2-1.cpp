...
int main() {
    ...
    std::cout << "Updated Battery Percentage: " << (myTesla.get_batteryPercentage()==myTesla.get_batteryPercentage()+0.1)<< "%" << std::endl;

    // Charge the battery
    myTesla.chargeBattery(120); // Charge for 120 minutes
    std::cout << "Charged Battery Percentage: " << (myTesla.get_batteryPercentage()==myTesla.get_batteryPercentage()+0.1)<< "%" << std::endl;
